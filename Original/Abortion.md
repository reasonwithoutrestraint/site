...
Rebuttal against 5:
- Obvious cases: self-defense, killing criminals. It is okay to kill people who would otherwise perform actions that harm someone else, where "perform actions that harm" is something more than just "existing". That is, if someone's mere existence causes your death, that doesn't mean that they can be killed.
