...
How to distinguish well-being (what makes a life go best) from reasons for action/desires? Some differences:
...
Reasons for action/desire = Reasons an agent has prior to perform an action
...
"Ideal" must not require specific elements in one's motivational set. Otherwise, it would be externalist, as it would be substantive rather than procedural.

Also, (1) needs to be argued for, as it is no longer merely a plattitude. It almost may seem to be question-begging against the externalist. We might be able to accept (1) if we accepted constructivism. Normative truth derives from the normative judgments an agent makes, and it is constituitive of agency to value one's motivations under deliberation. So we just need to argue for constructivism.
...
* Disconnects: Assume the normativity of desires are accounted for. How to account for disconnects between an agent's reasons and their desires? e.g. weakness of will (no desires created given reasons) and addiction (no reasons come from desires).
...
- Concern with one's future experiences.
...
- Normativity of desires: why do mere sensations/dispositions, in the absence of a normative judgment, provide a reason for action?

It doesn't seem that they do. Instead, we should focus on (1) the normative judgments an agent would make (e.g. their plans, goals), under (2) certain idealized conditions - full information, reflection, soundness, experience, etc.

#### Evaluating underived desires
...
#### Superset of constructivism

Constructivism seems to be a subset of dispositionalism. Consider a case where dispositionalism (but not constructivism) would say someone has reason:

E.g. if they *would* find K to be desirable/humorous if they were exposed to it (thus a reason under dispositionalism), even though they don't *currently* find it desirable/humorous despite knowing that they would if they were exposed to it (thus not a reason under constructivism). 

Constructivism maybe can account for this reason by claiming that it is constituitive of reasons for desire that one judge themselves to have reason to find X valuable if they believed that would find X valuable upon exposure.

Also, See general problems below
...
1. The elements posited as providing reasons (desires, informed desires, motivations, ideal desires, ideal observer's desires, etc.) don't necessarily provide reasons, i.e. when they disconnect with an agent's normative judgments.
...
3. Constructivism is the only theory that can give a general account of all reasons.