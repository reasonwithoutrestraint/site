...
Some Possibilities from other philosophers:
...
Possible standards correctness:
...
Note that this concerns standards of correctness, not moral psychology or meaning. I.e. even though one can sincerely judge that A has a moral duty to X despite believing that A lacks the appropriate reason to do X, whether A really does have a moral duty to X depends on A having the appropriate reason.
