...
(Descriptive) Non-naturalism and (descriptive) naturalistic asentimentalism are bogus.

Sentimentalism and constructivism are promising.

### Sentimental versus Constructive

Two kinds of moral reasons and two different standards of truth

1. Sentimental morality (aesthetic): truth predicated on the appropriateness of moral attitudes. This will be rational sentimentalism (assuming there is anything constituitive of moral attitudes) or dispositionalism. This emphasizes the *expressive* role of moral feelings.
...
### Aesthetic versus Justice

1. Aesthetic morality: 
...
- On another reading, these emotions have no constitutive meaning per se. They are mere tools to regulate society. As such, these emotions are warranted insofar as they promote the good of society (just as with individual rationality), i.e. positive states of consciousness, etc. The good of society should also be constrained in some way by consideration of the interests of the agents who are issued duties. Otherwise, those agents would have no reason to accept moral norms, but it is assumed that all agents have reason to be moral.
- Sits somewhere between ettiquette and justice, and is probably blurred in some way with ettiquette. 
...
- Moral statements might be true in this sense, but a person need not have any motivation or even reason to respect its law in any particular circumstances (even if they were fully informed/rational). They might have a reason, however, to support the construction of rules which society agrees to respect contingent upon an interest for such rules.
...
1. Private consequentialist: Consequentialist reason to follow the norm; depends on personal interests that would be promoted by the individual following the norm. 
	- Basic prudential reasons.
	- This can include the pleasure that one feels from the satisfaction of the following consistency: one knows that they have public constructive reason to support norm X that mandates behavior Y. So they support X. This doesn't entail a prudential reason to do X, but most people would do it because of a natural desire to be consistent.
	- This also includes the pleasure that arises from natural sympathy with others. People feel good treating others nicely.
...
Note that personal reasons a person has under the veil of ignorance =/= norms no one could reasonably reject as a basis for informed cooperation. The difference is that the former is concerned with individual, personal reasons that just so happen to be constrained with regard to information, whereas the latter are characteristically impartial, social reasons. E.g. even though it is rational to accept a system under the veil of ignorance that left everyone great except for one person who sufferred immensely, it would be rational for that one person to reject thoes norms as a basis for cooperation given a desire for cooperation.
...
Conclusions:
- A norm is must be immoral if it neglects the fully rational interests of any particular agent.
- A norm cannot be moral if it it meets the fully rational interests of every agent.
